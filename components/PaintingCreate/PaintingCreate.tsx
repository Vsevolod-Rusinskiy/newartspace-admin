import {Create, NumberInput, SimpleForm, TextInput, required, ImageInput, ImageField} from 'react-admin';
...
export const PaintingCreate = () => (
  <Create mutationMode="pessimistic">
    <SimpleForm>
      ...
      <TextInput source="name" label='Название картины' validate={requiredValidation}/>
