const selectLists = {
  ...
  materialsList: [
    ...
    { id: 8, value: 'Дерево' },
    { id: 9, value: 'Камень' },
    { id: 10, value: 'Каменная масса' },
    { id: 11, value: 'Картон' },
    { id: 12, value: 'Керамика' },
    { id: 13, value: 'Кожа' },
    { id: 14, value: 'Лён' },
    { id: 15, value: 'Мдф' },
    { id: 16, value: 'Металл' },
    { id: 17, value: 'Мозаика' },
    { id: 18, value: 'Нержавеющая сталь' },
    { id: 19, value: 'Оргалит' },
    { id: 20, value: 'Пвх' },
    { id: 21, value: 'Переработанный пластик' },
    { id: 22, value: 'Пластик' },
    { id: 23, value: 'Планшет' },
    { id: 24, value: 'Полимерный фарфор' },
    { id: 25, value: 'Полуфарфор' },
    { id: 26, value: 'Рисовая бумага' },
    { id: 27, value: 'Скальола' },
    { id: 28, value: 'Смешанная техника' },
    { id: 29, value: 'Стекло' },
    { id: 30, value: 'Стеклопластик' },
    { id: 31, value: 'Фанера' },
    { id: 32, value: 'Фарфор' },
    { id: 33, value: 'Фотобумага' },
    { id: 34, value: 'Хлопок' },
    { id: 35, value: 'Холст' },
    { id: 36, value: 'Цемент' },
    { id: 37, value: 'Шамот' },
    { id: 38, value: 'Шамотированная масса' },
    { id: 39, value: 'Эко кожа' },
    { id: 40, value: 'Led неон' },
    { id: 41, value: 'Винил' },
    { id: 42, value: 'Другое' },
  ],
  techniquesList: [
    ...
    { id: 4, value: 'Аэрозольная краска' },
    { id: 5, value: 'Авторская печать' },
    { id: 6, value: 'Глазурь' },
    { id: 7, value: 'Гуашь' },
    { id: 8, value: 'Деколь' },
    { id: 9, value: 'Карандаш' },
    ...
    { id: 11, value: 'Лак' },
    { id: 12, value: 'Левкас' },
    { id: 13, value: 'Лентикулярная варио-печать' },
    { id: 14, value: 'Линеры' },
    { id: 15, value: 'Линогравюра' },
    { id: 16, value: 'Масло' },
    { id: 17, value: 'Маркеры' },
    { id: 18, value: 'Мелки' },
    { id: 19, value: 'Пастель' },
    { id: 20, value: 'Патина' },
    { id: 21, value: 'Поталь' },
    { id: 22, value: 'Ручная проявка' },
    { id: 23, value: 'Сухая игла' },
    { id: 24, value: 'Темпера' },
    { id: 25, value: 'Тиражная печать' },
    { id: 26, value: 'Ткань' },
    { id: 27, value: 'Тушь' },
    { id: 28, value: 'Фотография' },
    { id: 29, value: 'Цифровая фотография' },
    { id: 30, value: 'Чернила' },
    { id: 31, value: 'Эгломизе' },
    { id: 32, value: 'Воск' },
  ],
  stylesList: [
